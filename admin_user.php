...
<input type='text' name='display' class='form-control' value='".$userdetails['display_name']."' />
</p>
<p>
<label>Email:</label>
...
<p>
<label>Title:</label>
<input type='text' name='title' class='form-control' value='".$userdetails['title']."' />
</p>
<p>
<label>Sign Up:</label>
